...
import { personalWebIcon, olshopIcon, compIcon, moreIcon, circle, dot, instagramIcon, emailIcon, phoneIcon, locationIcon, telegramIcon } from '../../assets';
    ...
    return (
        <div className='px-10 md:px-16 lg:px-20 xl:px-28 py-14 scroll-smooth'>
            ...
            <section className='mt-44'>
                <div className='flex flex-col gap-12 w-1/2'>
                    <div className='flex flex-col gap-5'>
                        <h1 className='text-5xl font-bold leading-normal'>Bring the <span className='text-indigo-500'>Best Solution</span> for Your Need</h1>
                        <p className='text-base text-slate-400'>We are website development agency that focused help you grow your business online</p>
                    </div>
                    <Button isPrimary={true} isLarge={false} >See Our Works</Button>
                </div>
            </section>
                ...
                <div className='flex flex-col lg:flex-row gap-8'>
                    ...
                    <div className='flex flex-col gap-8 w-4/5'>
                        ...
                        <div className='flex items-stretch'>
                            <button className='self-center text-base mr-2 font-semibold text-orange-400'>Read More</button>
            ...
            <section className='flex flex-col gap-14 mt-20'>
                <div className='flex flex-col gap-4'>
                    <h5 className='text-xl font-semibold text-center text-indigo-500'>SERVICES</h5>
                    <div className='flex flex-col gap-2'>
                        <h2 className='text-4xl font-bold text-center'>Our Provided Services</h2>
            ...
            <section className='flex flex-col gap-8 lg:gap-0 lg:flex-row justify-between mt-40'>
                <div className='flex flex-col self-center gap-16 w-full lg:w-2/5'>
                    <div>
                        ...
                        <div className='flex flex-col gap-4'>
                            <h2 className='text-4xl font-bold'>Are you interested to start work with us?</h2>
                    ...
                    <div className='flex gap-8 lg:gap-0 lg:justify-between'>
                        <div className='flex flex-col gap-9'>
                            <div className='flex items-stretch gap-4'>
                                ...
                                <p className='self-center text-xl mr-2 font-semibold'>+6285740564139</p>
                            </div>
                            <div className='flex items-stretch gap-4'>
                                <img src={emailIcon} alt="arrow" />
                                <p className='self-center text-xl mr-2 font-semibold'>hello@twillio.com</p>
                            </div>
                        </div>
                        <div className='flex flex-col gap-9'>
                            <div className='flex items-stretch gap-4'>
                                <img src={instagramIcon} alt="arrow" />
                                <p className='self-center text-xl mr-2 font-semibold'>@twillio.agency</p>
                            </div>
                            <div className='flex items-stretch gap-4'>
                                <img src={locationIcon} alt="arrow" />
                                <p className='self-center text-xl mr-2 font-semibold'>Open Google Maps</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='relative w-full lg:w-1/2 p-14'>
                    ...
                    <div className='relative flex flex-col gap-8 p-8 rounded-2xl bg-white shadow-lg z-40'>
                        <h3 className='text-2xl font-bold z-50'>Get in <span className='text-indigo-500'>touch</span></h3>
                        <form className='z-50'>
                            <div className='flex flex-col mb-8 gap-3'>
                                <label for="email" className='text-base font-semibold'>
                                    Your email
                                </label>
                                <input className='rounded-xl text-base text-slate-500 p-3 bg-slate-100' type="email" id="email" placeholder="Enter your email" />
                            </div>
                            <div className='flex flex-col mb-8 gap-3'>
                                <label for="email" className='text-base font-semibold'>
                                    Messages
                                </label>
                                <input className='rounded-xl text-base text-slate-500 p-3 bg-slate-100' type="email" id="email" placeholder="Enter your messages" />
                            </div>
                            <Button className="flex" isLarge={true}>
                                <svg className="self-center mr-4 fill-white rotate-90" width="16" height="16" viewBox="0 0 51 51">
